...
//   Bugme = 0;  // debugging signal high during Timer0 interrupt on PTB9
  ...
  if (timer_state == 1000)
  {
    ...
    pc1.printf("Total Program Execution time: 100 milliseconds\n\r\n\r");
    
    double processor_load = timer_read*10;
         
    pc1.printf("RESULT\n\r");
    pc1.printf("Processor load in percentage of CPU cycles %f\n\r", processor_load);
    pc1.printf("CPU available percentage is %f\n\r", 100.0 - processor_load);      
  }
}
