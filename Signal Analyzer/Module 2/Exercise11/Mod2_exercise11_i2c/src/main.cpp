...
int main(){
	while(1){
		...
		*/
		...
		temp_sensor.write(temp_addr,cmd1,1);//write the start command
		temp_sensor.write(temp_addr,cmd2,1);//write the read temperature command
